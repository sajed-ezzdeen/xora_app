...
const Faq = () => {  
  ...
  return (
    <section>
        ...
        <div className="flex-glow_before relative z-2 border-2 border-s2 bg-s1">
            ...
            <div className="faq-line_after absolute left-[calc(50%-1px)] top-0 h-full w-0.5 bg-s2 max-lg:hidden"/>
        </div> 
